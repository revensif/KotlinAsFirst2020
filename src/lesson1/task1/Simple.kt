 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (4.445 / 100) * (48 * sagenes + 16 * arshins + vershoks)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (1 + 0.01 * percent).pow(3) * initial
